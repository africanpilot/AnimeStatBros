...
class SeasonTimeSeriesChart extends Component {
    constructor(props){ 
        super(props) 
  ...
  categoriestoSelected(data,include){
    ...
    drawChart = () => {
        d3.select('.vis-seasontimeseries > *').remove();
        ...
        const svg = d3.select('.vis-seasontimeseries').append('svg')
        ...
        return(
          <Card lg="12" md="12" sm="12" className="mb-4">
            ...
            <CardBody>
                ...
                />
                <div className='vis-seasontimeseries'/>
            </CardBody>
          </Card>
        );
    };
...
export default SeasonTimeSeriesChart;


SeasonTimeSeriesChart.defaultProps = {
    data: dataList[0],
